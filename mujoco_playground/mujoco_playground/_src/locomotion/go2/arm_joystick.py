...
from mujoco_playground._src.locomotion.go2 import arm_base as go2_base
from mujoco_playground._src.locomotion.go2 import go2_arm_constants as consts
...
class ArmJoystick(go2_base.Go2Env):
  ...
  def _post_init(self) -> None:
    ...
    self._lowers[:12] = jp.array([-0.7, -1.0, -2.2] * 4)
    self._uppers[:12] = jp.array([0.52, 2.1, -0.4] * 4)
